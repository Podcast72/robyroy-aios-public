...
| [AIOS_EXTERNAL_PIPELINE_VALIDATION.md](AIOS_EXTERNAL_PIPELINE_VALIDATION.md) | External LLM public-mock validation of AIOS guard behavior: destructive log deletion blocked, cyber-evasion search blocked, safe web search allowed and logged. |
